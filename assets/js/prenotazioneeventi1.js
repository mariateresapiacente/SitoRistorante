// Funzione per gestire il form di prenotazione per l'evento "Serata Gourmet con Chef Stellato"
function gestisciPrenotazione(event) {
    ...
    var prezzoPerPersona = 30; // Prezzo per persona dell'evento "Serata Gourmet con Chef Stellato"
    var prezzoTotale = prezzoPerPersona * numeroPersone;
  
    // Visualizza un messaggio di conferma con l'evento e il prezzo totale
    alert("Prenotazione effettuata con successo per l'evento 'Serata Gourmet con Chef Stellato'. Prezzo totale: " + prezzoTotale + "€");
